import { AlignLeft, Compass, HeartHandshake, MapPin, MapPinned, Navigation, Phone } from 'lucide-react'
...
export type RedCrescentPayload = {
  name: string
  provinceId: string
  cityId: string
  phone: string | null
...
export function RedCrescentForm({
  initial,
  provinces,
  cities,
  onProvinceChange,
  ...
  onSubmit: (payload: RedCrescentPayload) => Promise<void>
}) {
  ...
  return (
    ...
    <AppForm onSubmit={submit} className={formCardBodyClassName}>
      ...
      <FormField icon={HeartHandshake} label={t('redCrescents.name')} htmlFor="name">
        <input
          id="name"
      ...
      <FormField icon={Phone} label={t('redCrescents.phone')} htmlFor="phone">
        <input
          id="phone"
          className={fieldClassName}
          value={values.phone}
      ...
      <FormField icon={MapPin} label={t('redCrescents.address')} htmlFor="address">
        <textarea
          id="address"
          className={fieldClassName}
          rows={3}
      ...
      <FormField icon={AlignLeft} label={t('redCrescents.description')} htmlFor="description">
        <textarea
          id="description"
          className={fieldClassName}
          rows={4}
      ...
      <FormActions
        submitLabel={t('redCrescents.save')}
        cancelLabel={t('redCrescents.cancel')}
        submitting={saving}
