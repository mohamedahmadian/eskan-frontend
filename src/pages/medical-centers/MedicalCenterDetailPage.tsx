...
export function MedicalCenterDetailPage() {
  ...
  return (
    <div className={formShellClassName}>
      <PageHeader title={t('medicalCenters.details')} subtitle={t('medicalCenters.detailsSubtitle')} />
      <article className="rounded-2xl border border-line bg-white p-6 shadow-sm">
        <dl className="grid gap-3 text-sm">
          ...
          <DetailRow label={t('medicalCenters.phone')} value={item.phone ? localizeDigits(item.phone, locale) : '—'} />
