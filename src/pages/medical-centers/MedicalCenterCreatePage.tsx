...
export function MedicalCenterCreatePage() {
  ...
  const listTo = listQuery
    ? `/base-info/medical-centers?${listQuery}`
    : '/base-info/medical-centers'

  return (
    <div className={formShellClassName}>
      <PageHeader title={t('medicalCenters.create')} subtitle={t('medicalCenters.createSubtitle')} />
      <MedicalCenterForm
        initial={
        ...
        onSubmit={async (payload) => {
          await api.post('/medical-centers', payload)
          toast.success(t('medicalCenters.created'))
          navigate(listTo)
        }}
      />
    </div>
