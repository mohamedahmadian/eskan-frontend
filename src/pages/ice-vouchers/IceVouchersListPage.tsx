import { Banknote, CalendarDays, Filter, MessageSquare, Plus, Snowflake } from 'lucide-react'
...
export function IceVouchersListPage() {
  ...
  const query = useQuery({
    queryKey: ['ice-vouchers', 'list', q, year, status, paymentStatus, page, sortBy, sortDir],
    queryFn: async () => {
